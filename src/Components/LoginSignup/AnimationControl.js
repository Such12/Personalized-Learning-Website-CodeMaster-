...
function ControlStatementAnimationPage() {
  const animationUrls = [
    '/ControlStatements1.mp4',
    '/ControlStatements2.mp4',
    '/ControlStatements3.mp4',
    '/ControlStatements4.mp4',
    '/ControlStatements5.mp4',
  ];
...
export default ControlStatementAnimationPage;
