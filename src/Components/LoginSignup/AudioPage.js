        ...
        <div style={pageStyle}> 
            <div className="main-container">
                <div className="audio-page">
                    <h1>Audio Tutorials</h1>
                    <p>Here you can listen to engaging audio clips that break down coding concepts into easy-to-understand segments.</p>
                    
                    <div className="audio-categories">
                        <div className="category">
                            <Link to="/audio-introduction">
                                <h3>Introduction</h3>
                            </Link>
                        ...
                        <div className="category">
                            <Link to="/audio-control-statements"> 
